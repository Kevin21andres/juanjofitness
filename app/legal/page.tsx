export default function Legal() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-16 text-gray-700">
      <h1 className="text-3xl font-bold text-black mb-8">Aviso Legal</h1>
      ...
      <ul className="mb-6 space-y-2">
        ...
        <li><strong>Actividad:</strong> Entrenamiento personal y asesoramiento deportivo</li>
      </ul>
      ...
      <p className="mb-6">
        ...
        implica la aceptación plena de las presentes condiciones. El usuario se
      ...
      <p className="mb-6">
        Todos los contenidos de esta web (textos, imágenes, logotipos, diseño,
        estructura y código fuente) son propiedad de Juan Jose Hidalgo Pomes
        o cuentan con licencia para su uso, quedando prohibida su reproducción
